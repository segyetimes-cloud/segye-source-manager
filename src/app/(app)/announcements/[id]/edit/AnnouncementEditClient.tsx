...
export default function AnnouncementEditClient({
  announcement,
}: {
  announcement: { id: string; title: string; body: string | null; is_pinned: boolean }
}) {
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="glass-card p-6 space-y-4">
        <div>
          ...
          <input value={title} onChange={e => setTitle(e.target.value)} placeholder="공지 제목" style={inputStyle} />
        </div>
        <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <label htmlFor="pin" className="text-sm cursor-pointer" style={{ color: '#A87228' }}>📌 상단 고정</label>
        </div>
